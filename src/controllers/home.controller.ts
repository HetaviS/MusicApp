...
async function songsByGenre(req: Request, res: Response) {
    try {
        const songs = await home_service.getAllSongsByGenre(req.body.page, req.body.limit);
...
async function updateBlock(req: Request, res: Response) {
    try {
        const block = await home_service.updateBlock(req.body, parseInt(req.params.blockId));
        if (!block) {
...
async function addDataToBlock(req: Request, res: Response) {
    try {
        const block = await home_service.addDataToBlock(parseInt(req.params.blockId), req.body);
        if (!block) {
            return response_service.notFoundResponse(res, 'Block not found.');
        }
...
async function removeDataFromBlock(req: Request, res: Response) {
    try {
        const block = await home_service.removeDataFromBlock(parseInt(req.params.blockId), req.body);
        if (!block) {
            return response_service.notFoundResponse(res, 'Block not found.');
        }
...
async function getAllBlocks(req: Request, res: Response) {
    try {
        const blocks = await home_service.getAllBlocks(req.body.page, req.body.limit);
...
async function getBlockById(req: Request, res: Response) {
    try {
        const block = await home_service.getBlock(parseInt(req.params.blockId));
        if (!block) {
            return response_service.notFoundResponse(res, 'Block not found.');
        }
...
async function deleteBlock(req: Request, res: Response) {
    try {
        const block = await home_service.updateBlock({ is_deleted: true }, parseInt(req.params.blockId));
        if (!block) {
            return response_service.notFoundResponse(res, 'Block not found.');
        }
